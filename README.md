...
This program for the GameBoy Advance allows you to create songs with a preset voicebank (provided ones are generated with espeak and the script in `generator/`). It's pretty basic, but does support:

- Different BPMs
- Muiltiple tracks (4 by default)
- Different voicebanks (through multiple different ROMs)
